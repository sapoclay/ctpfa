...
def run_main_app():
    """Ejecuta la aplicación principal retro_cms.py"""
    python_exe = get_python_executable()
...
╔═══════════════════════════════════════════════════════════════════════════════╗
║                             ⚡ CTPFA CMS ⚡                                    ║
║              Cualquier Tiempo Pasado Fue Anterior - Editor                    ║
╚═══════════════════════════════════════════════════════════════════════════════╝
""")
